...
const cmsShellCss = `.header .header-inner,.footer .footer-inner{max-width:100%;margin-left:auto;margin-right:auto;padding-left:var(--shell-inline-padding);padding-right:var(--shell-inline-padding)}#main,#main>article{padding-left:0;padding-right:0}#main>article{padding:0}.content.no-right-rail{padding:0 var(--space-8)}.content.no-right-rail:has(> .ic-section){padding:0}.content.no-right-rail h1:only-child{position:absolute!important;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0}.breadcrumb{margin:calc(25rem / var(--rem-base)) auto;padding:0 var(--shell-inline-padding)}@media screen and (min-width:1520px){.ic-section .container,.ic-header .container,.breadcrumb,.header .header-inner,.footer .footer-inner{max-width:var(--shell-max-width)!important}}`;
...
const cmsFormStylesheetTag = `<link href="/Content/FormSections/TwoColumnSection.css" rel="stylesheet">`;
...
function renderCmsLinkTags(source, page) {
  ...
  if (pageUsesCmsForm(page)) {
    links.push(cmsFormStylesheetTag);
  }
