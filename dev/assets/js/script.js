(() => {
  ...
  function initDropdownButtons() {
    document.addEventListener("click", (event2) => {
      const button = event2.target.closest(BTN_SEL);
  ...
  // dev/assets/js/src/features/swiper-media.js
  ...
  function initSwatches() {
    ...
    swatches.forEach((swatch) => {
      swatch.addEventListener("click", (event2) => {
  ...
  // dev/assets/js/src/features/swiper-default.js
  ...
  // dev/assets/js/src/features/swiper-courses.js
